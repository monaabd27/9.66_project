...
p_harm_averages = [0.033821777, 0.255182789, 0.082900495, 0.277950774, 0.162973162, 0.30249444, 0.067307358, 0.243347983, 0.076269175, 0.086840784, 0.242906794, 0.444233919, 0.081700562]
lives = [(1, 5), (1, 5), (1, 2), (1, 2), (1, 1), (1, 1), (1, 1), (2, 1), (2, 1), (5, 1), (1, 5), (5, 1), (5, 1)]
for i in range(len(lives)):
    p_harm = p_harm_averages[i]
    lives_lost = lives[i][0]
    lives_saved = lives[i][1]
    print(full_permissibility(0.8, p_harm, lives_lost, lives_saved))
...
#intended to harm someone given that they took action A
...
def full_permissibility(w=0.8, p_harm, lives_lost, lives_saved):
